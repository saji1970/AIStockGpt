    ...
    def _load_intent_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "market_advice": [
                r"top\s*\d+\s*stocks?",
                r"best\s*stocks?",
                r"best.*(?:invest|option|pick|buy)",
                r"invest\s*\$?\d+",
                r"where.*(?:invest|put.*money)",
                r"hedge\s*fund",
                r"mutual\s*fund",
                r"etf.*(?:recommend|best|top|buy)",
                ...
                r"diversif",
                r"sector.*(?:perform|best|top|hot)",
                r"asset.*allocation",
                r"(?:current|today).*market",
                r"index.*fund",
                r"s.?p\s*500",
                r"nasdaq|dow\s*jones",
                r"crypto.*(?:invest|buy|best)"
            ],
            "retirement_planning": [
